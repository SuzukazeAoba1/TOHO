...
public class SpawnPattenDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        var sequenceidRect  = new Rect(x4, position.y, 40, position.height);
        var spawnfilpRect   = new Rect(x5, position.y, 20, position.height);
        ...
        EditorGUI.PropertyField(sequenceidRect, property.FindPropertyRelative("m_movesequenceid"), GUIContent.none);
